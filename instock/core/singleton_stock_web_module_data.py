    ...
    def __init__(self):
        ...
        self.data_list = [
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_BLOCKTRADE["columns"]
                ),
                primary_key=[],
                is_realtime=False,
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_FUND_FLOW_INDUSTRY["columns"]
                ),
                primary_key=[],
                is_realtime=True,
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_FUND_FLOW_CONCEPT["columns"]
                ),
                primary_key=[],
                is_realtime=True,
                order_by=" `fund_amount` DESC",
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_INDICATORS["columns"]
                ),
                primary_key=[],
                is_realtime=False,
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_INDICATORS_BUY["columns"]
                ),
                primary_key=[],
                is_realtime=False,
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_INDICATORS_SELL["columns"]
                ),
                primary_key=[],
                is_realtime=False,
            ...
            wmd.web_module_data(
                ...
                column_names=tbs.get_field_cns(
                    tbs.TABLE_CN_STOCK_KLINE_PATTERN["columns"]
                ),
                primary_key=[],
                is_realtime=False,
